...
import com.bio.generator.domain.ColumnDO;
import com.bio.generator.domain.TableDO;
...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip) {
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new DashboardException(EnumErrorCode.genRenderTemplateError.getCodeStr());
            }
        }
    }
    ...
    public static Configuration getConfig() {
        try {
            ...
            throw new DashboardException(EnumErrorCode.genReadConfigError.getCodeStr());
        }
    }
