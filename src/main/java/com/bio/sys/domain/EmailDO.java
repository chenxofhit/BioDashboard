...
public class EmailDO {
	...
	public EmailDO(String from, String toList, String subject, String message) {
		this();
		this.from = from;
	...
	public EmailDO(String from, String toList, String ccList) {
		this();
		this.from = from;
		this.to = splitByComma(toList);
	...
	public EmailDO(String from, String toList) {
		this();
		this.from = from;
		this.to = splitByComma(toList);
	}
	
	public EmailDO(String from, String toList, String ccList, String subject, String message) {
		this();
		this.from = from;
		this.subject = subject;
		this.message = message;
