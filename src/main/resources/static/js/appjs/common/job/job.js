var prefix = document.getElementsByTagName('meta')['ctx'].content +"/common/job"
$(function() {
	load();
});
						...
						columns : [
...

								{
									...
									formatter : function(value, row, index) {
										...
										var f = '<a class="btn btn-success btn-sm" href="#" title="运行一次"  mce_href="#" onclick="runOnce(\''
												+ row.id
